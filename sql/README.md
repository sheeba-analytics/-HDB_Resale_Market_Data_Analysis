...
This folder contains SQL queries used for analyzing the Singapore HDB resale dataset.
...
These queries were used to prepare data insights before building the Power BI dashboard.
